...
import { View, Text, Image,TextInput, ScrollView,ProgressBarAndroid, TouchableOpacity, StyleSheet, Dimensions } from 'react-native';
        ...
        <View style={styles.container}>
          ...
          <TextInput
            ...
            <View style={styles.trending}>
              <Ionicons style={styles.icon_tren} name="trending-up-outline" size={ 26} color={'#fff'} />
