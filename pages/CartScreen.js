    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        >
          ...
          <Text numberOfLines={1} style={styles.textAddress}>Xã Quảng Ngạn, Huyện Quảng Điền, Thừa Thiên Huế</Text>
      ...
      <View style={styles.footer}>
        <View style={{ flexDirection: 'column', padding: 16 }}>
          ...
          <Text style={{ fontSize: 22, color: colors.redPrice, fontWeight: 600, marginTop: 4 }}>
            {
              !totalPrice ? (<Text style={{ fontSize: 14, color: colors.redPrice, fontWeight: 400 }}>Vui lòng chọn sản phẩm</Text>)
