...
export default function OrderConfirmScreen() {
  ...
  const handleClickBtOrder = async () => {
    ...
    if (selectedPayment.toString() === method_payments.CASH) {
      const dataResponse = await createOrder(
        API_POST_PATHS.tao_don_hang,
        order_data
      );
  ...
  return (
    <View style={styles.container}>
      ...
      <FooterComponent
        handleClickBtOrder={handleClickBtOrder}
        total_price={total_price}
      ></FooterComponent>
    </View>
  );
...
function CashPaymentComponent({ selectedPayment, handlePaymentClick }) {
  return (
    <TouchableOpacity
      style={[
        styles.methodPayment,
        selectedPayment === method_payments.CASH && {
...
function ZaloPayComponent({ selectedPayment, handlePaymentClick }) {
  return (
    <TouchableOpacity
      style={[
        styles.methodPayment,
        selectedPayment === method_payments.ZaloPay && {
          backgroundColor: "rgba(5, 0, 245, 0.1)",
        },
      ]}
  ...
  return (
    <View>
      ...
      <View style={styles.footerOrderValue}>
        ...
        <Text style={{ color: colors.blueRoot }}>
...
function FooterComponent(props) {
  ...
  return (
    <View style={styles.footer}>
      ...
      <TouchableOpacity style={styles.btOrder} onPress={handleClickBtOrder}>
